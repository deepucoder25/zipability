            ...
            <form method="post" id="reviewsform" onsubmit="return false">
                <div class="row">
                    ...
                    <div class="col-12 text-center">
                        <div id="result"></div>
                        <button id="submitbtn" type="submit" class="theme-btn" style="background-color: #FBA707;">Submit<i class="bi bi-send"></i></button>
                        <button onclick="$('#result').html('');" type="reset"  class="theme-btn" style="background-color: white; color: #A0A0A0;">Clear <i class="bi bi-trash"></i></button>
                    </div>
                </div>
            </form>
        </div>
